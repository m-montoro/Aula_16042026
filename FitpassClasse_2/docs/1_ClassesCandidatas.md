...
##
- RF08 — **AVALIAÇÃO FISICA** - **INSTRUTORES** devem registrar avaliações físicas (peso, IMC, percentual de gordura etc.) e anexar arquivos se necessário.
##
...
##
- RF10 — **NOTIFICAÇÃO** - O sistema deve enviar notificações ao aluno sobre: vencimento de mensalidade, confirmação de agendamento, liberação de nova avaliação física
